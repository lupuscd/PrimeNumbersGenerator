...
numberentry = Entry(window, width=15, bg='white', fg='black', font='arial 12')
numberentry.grid(row=0, column=1)
numberentrytwo = Entry(window, width=15, bg='white', fg='black', font='arial 12')
numberentrytwo.grid(row=2, column=1)
primeout = ScrolledText(window, width=60, height=4, bg='white', fg='black', font='arial 12')
